...
impl GlineBackend {
    ...
    pub fn new(repo_id: Option<String>) -> PyResult<GlineBackend> {
        kreuzberg::text::ner::gline::GlineBackend::new(repo_id.as_deref())
            .map(Into::into)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))
    }
...
impl LlmBackend {
    ...
    pub fn new(config: LlmConfig) -> LlmBackend {
        ...
        Self {
            inner: Arc::new(kreuzberg::text::ner::llm::LlmBackend::new(config_core)),
        }
    }
}
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (text, llm_config, max_tokens=None))]
pub fn summarize_with_llm<'py>(
    py: Python<'py>,
    text: String,
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        let llm_config_json =
            serde_json::to_string(&llm_config).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let llm_config_core: kreuzberg::LlmConfig = serde_json::from_str(&llm_config_json)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let result = kreuzberg::text::summarization::llm::summarize_with_llm(&text, &llm_config_core, max_tokens)
            .await
            .map_err(|e| PyErr::new::<PyRuntimeError, _>(e.to_string()))?;
        Ok(result)
    })
...
#[pyfunction]
#[pyo3(signature = (image_bytes, image_mime, region_kind, llm_config, custom_prompt=None))]
pub fn extract_region_with_vlm_usage<'py>(
    py: Python<'py>,
    image_bytes: Vec<u8>,
    image_mime: String,
    region_kind: RegionKind,
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        let region_kind_json = serde_json::to_string(&region_kind)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let region_kind_core: kreuzberg::RegionKind = serde_json::from_str(&region_kind_json)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let llm_config_json =
            serde_json::to_string(&llm_config).map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let llm_config_core: kreuzberg::LlmConfig = serde_json::from_str(&llm_config_json)
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (llm_config, prompt, schema_name, schema, source))]
pub fn complete_with_json_schema<'py>(
    py: Python<'py>,
    llm_config: LlmConfig,
    prompt: String,
    schema_name: String,
...
#[allow(clippy::missing_errors_doc)]
#[pyfunction]
#[pyo3(signature = (llm_config, prompt, source))]
pub fn complete_text<'py>(
    py: Python<'py>,
    llm_config: LlmConfig,
    prompt: String,
    source: String,
    ...
    pyo3_async_runtimes::tokio::future_into_py(py, async move {
        ...
        let llm_config_core: kreuzberg::LlmConfig = serde_json::from_str(&llm_config_json)
            .map_err(|e| pyo3::exceptions::PyRuntimeError::new_err(e.to_string()))?;
        let result = kreuzberg::llm::text_completion::complete_text(&llm_config_core, &prompt, &source)
            .await
            .map_err(|e| PyErr::new::<PyRuntimeError, _>(e.to_string()))?;
        Ok(result)
    })
...
pub fn _kreuzberg(m: &Bound<'_, PyModule>) -> PyResult<()> {
    ...
    m.add_function(wrap_pyfunction!(summarize_with_llm, m)?)?;
    ...
    m.add_function(wrap_pyfunction!(extract_region_with_vlm_usage, m)?)?;
    m.add_function(wrap_pyfunction!(complete_with_json_schema, m)?)?;
    m.add_function(wrap_pyfunction!(complete_text, m)?)?;
