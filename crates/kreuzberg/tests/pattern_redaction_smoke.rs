...
use kreuzberg::core::config::redaction::RedactionConfig;
use kreuzberg::plugins::PostProcessor;
use kreuzberg::plugins::processor::builtin::redaction::RedactionProcessor;
use kreuzberg::types::ExtractionResult;
use kreuzberg::types::redaction::{PiiCategory, RedactionStrategy};
...
fn redacts_user_supplied_literal_term_case_insensitive() {
    use kreuzberg::core::config::redaction::RedactionTerm;
...
fn redacts_user_supplied_regex_pattern() {
    use kreuzberg::core::config::redaction::RedactionPattern;
