...
// alef:hash:6a95635189745b7748b1e56f06a2b3fb264a17094d0f4bf7f7ced1658f98dbba
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<EmbeddingPreset2> for kreuzberg::EmbeddingPreset {
    fn from(val: EmbeddingPreset2) -> Self {
        Self {
            name: val.name,
