...
// alef:hash:8b71f3ae545b84639de72cf213687a5ecaf1c89fd16bf462a4993f80c27a6530
...
impl From<kreuzberg::FormatMetadata> for JsFormatMetadata2 {
    fn from(val: kreuzberg::FormatMetadata) -> Self {
        match val {
            kreuzberg::FormatMetadata::Pdf(_pdf) => Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<JsEmbeddingPreset2> for kreuzberg::EmbeddingPreset {
    fn from(val: JsEmbeddingPreset2) -> Self {
        Self {
            name: val.name,
