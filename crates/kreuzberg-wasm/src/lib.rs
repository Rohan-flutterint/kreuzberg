...
// alef:hash:3dec004294312367c194a8abc0d332a5280bb63448fe27ace841b51037044f07
...
impl WasmMetadata {
    ...
    #[wasm_bindgen(getter)]
    pub fn custom(&self) -> JsValue {
        self.custom.clone()
    }

    #[wasm_bindgen(setter)]
    pub fn set_custom(&mut self, value: JsValue) {
        self.custom = value;
    }
...
impl From<WasmMetadata> for kreuzberg::Metadata {
    fn from(val: WasmMetadata) -> Self {
        Self {
            ...
            custom: serde_wasm_bindgen::from_value(val.custom.clone()).unwrap_or_default(),
        }
    }
}
...
impl From<kreuzberg::Metadata> for WasmMetadata {
    fn from(val: kreuzberg::Metadata) -> Self {
        Self {
            ...
            output_format: val.output_format,
            extraction_method: val.extraction_method,
            custom: js_sys::JSON::parse(&serde_json::to_string(&val.custom).unwrap_or_default())
                .unwrap_or(JsValue::NULL),
        }
    }
}
