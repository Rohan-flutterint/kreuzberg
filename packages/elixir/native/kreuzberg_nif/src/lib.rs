...
pub struct TokenCounter {
    inner: Arc<kreuzberg::text::redaction::strategy::TokenCounter>,
}
...
pub fn redact_async(result: Option<String>, config: Option<String>) -> Result<(), String> {
    let result_core: Option<kreuzberg::ExtractionResult> = result
        ...
        .transpose()
        .map_err(|e| e.to_string())?;
    let config_core: Option<kreuzberg::core::config::RedactionConfig> = config
        .map(|s| serde_json::from_str::<kreuzberg::core::config::RedactionConfig>(&s))
        .transpose()
        .map_err(|e| e.to_string())?;
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
...
pub fn redactionconfig_validate(obj: RedactionConfig) -> Result<(), String> {
    let result = kreuzberg::core::config::RedactionConfig::from(obj)
        .validate()
        .map_err(|e| e.to_string())?;
    Ok(result)
}
...
pub fn glinebackend_new(repo_id: Option<String>) -> Result<GlineBackend, String> {
    let result = kreuzberg::text::ner::gline::GlineBackend::new(repo_id.as_deref()).map_err(|e| e.to_string())?;
    Ok(result.into())
}
    ...
    let result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        std::thread::Builder::new()
            ...
            .spawn(move || {
                ...
                let result = rt
                    .block_on(async {
                        kreuzberg::text::ner::gline::GlineBackend::from(obj)
...
pub fn llmbackend_new(config: Option<String>) -> ResourceArc<LlmBackend> {
    ...
    ResourceArc::new(LlmBackend {
        inner: Arc::new(kreuzberg::text::ner::llm::LlmBackend::new(
...
pub fn tokencounter_new() -> ResourceArc<TokenCounter> {
    ResourceArc::new(TokenCounter {
        inner: Arc::new(kreuzberg::text::redaction::strategy::TokenCounter::new()),
    })
}
