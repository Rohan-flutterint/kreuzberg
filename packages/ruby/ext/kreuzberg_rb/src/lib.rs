...
// alef:hash:dfd909fae7478107eb50fc1eb197f94c44408c6384f850ac688acdaf1ccac0b1
...
fn ruby_init(ruby: &Ruby) -> Result<(), Error> {
    ...
    class.define_method("custom", method!(Metadata::custom, 0))?;
