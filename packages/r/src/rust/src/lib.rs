...
pub fn batch_extract_files_sync(items: String, config: &ExtractionConfig) -> Result<String> {
    match (|| -> Result<String> {
        ...
        let config_core: kreuzberg::ExtractionConfig = config.clone().into();
        let result = kreuzberg::batch_extract_files_sync(items_core.as_slice(), &config_core).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn batch_extract_bytes_sync(items: String, config: &ExtractionConfig) -> Result<String> {
    match (|| -> Result<String> {
        ...
        let config_core: kreuzberg::ExtractionConfig = config.clone().into();
        let result = kreuzberg::batch_extract_bytes_sync(items_core.as_slice(), &config_core).map_err(|e| {
            extendr_api::Error::Other(
                e.to_string()
                    .replace(":", "_")
                    .replace("/", "_")
...
pub fn batch_extract_files(items: String, config: &ExtractionConfig) -> Result<String> {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            kreuzberg::batch_extract_files(items_core.as_slice(), &config_core)
                .await
                .map_err(|e| {
                    extendr_api::Error::Other(
                        e.to_string()
...
pub fn batch_extract_bytes(items: String, config: &ExtractionConfig) -> Result<String> {
    match (|| -> Result<String> {
        ...
        let result = rt.block_on(async {
            kreuzberg::batch_extract_bytes(items_core.as_slice(), &config_core)
                .await
                .map_err(|e| {
                    extendr_api::Error::Other(
                        e.to_string()
