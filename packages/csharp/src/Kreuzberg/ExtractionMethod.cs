...
internal sealed class ExtractionMethodJsonConverter : JsonConverter<ExtractionMethod>
{
    public override ExtractionMethod Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "native" => ExtractionMethod.Native,            "ocr" => ExtractionMethod.Ocr,            "mixed" => ExtractionMethod.Mixed,            _ => throw new JsonException($"Unknown ExtractionMethod value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, ExtractionMethod value, JsonSerializerOptions options)
    {
        ...
        {            ExtractionMethod.Native => "native",            ExtractionMethod.Ocr => "ocr",            ExtractionMethod.Mixed => "mixed",            _ => throw new JsonException($"Unknown ExtractionMethod value: {value}")
        };
