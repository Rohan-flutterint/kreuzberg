...
internal sealed class CodeContentModeJsonConverter : JsonConverter<CodeContentMode>
{
    public override CodeContentMode Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "chunks" => CodeContentMode.Chunks,            "raw" => CodeContentMode.Raw,            "structure" => CodeContentMode.Structure,            _ => throw new JsonException($"Unknown CodeContentMode value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, CodeContentMode value, JsonSerializerOptions options)
    {
        ...
        {            CodeContentMode.Chunks => "chunks",            CodeContentMode.Raw => "raw",            CodeContentMode.Structure => "structure",            _ => throw new JsonException($"Unknown CodeContentMode value: {value}")
        };
