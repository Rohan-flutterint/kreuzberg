...
internal sealed class ImageKindJsonConverter : JsonConverter<ImageKind>
{
    public override ImageKind Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "photograph" => ImageKind.Photograph,            "diagram" => ImageKind.Diagram,            "chart" => ImageKind.Chart,            "drawing" => ImageKind.Drawing,            "text_block" => ImageKind.TextBlock,            "decoration" => ImageKind.Decoration,            "logo" => ImageKind.Logo,            "icon" => ImageKind.Icon,            "tile_fragment" => ImageKind.TileFragment,            "mask" => ImageKind.Mask,            "unknown" => ImageKind.Unknown,            _ => throw new JsonException($"Unknown ImageKind value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, ImageKind value, JsonSerializerOptions options)
    {
        ...
        {            ImageKind.Photograph => "photograph",            ImageKind.Diagram => "diagram",            ImageKind.Chart => "chart",            ImageKind.Drawing => "drawing",            ImageKind.TextBlock => "text_block",            ImageKind.Decoration => "decoration",            ImageKind.Logo => "logo",            ImageKind.Icon => "icon",            ImageKind.TileFragment => "tile_fragment",            ImageKind.Mask => "mask",            ImageKind.Unknown => "unknown",            _ => throw new JsonException($"Unknown ImageKind value: {value}")
        };
