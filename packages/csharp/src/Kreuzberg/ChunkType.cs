...
internal sealed class ChunkTypeJsonConverter : JsonConverter<ChunkType>
{
    public override ChunkType Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "heading" => ChunkType.Heading,            "party_list" => ChunkType.PartyList,            "definitions" => ChunkType.Definitions,            "operative_clause" => ChunkType.OperativeClause,            "signature_block" => ChunkType.SignatureBlock,            "schedule" => ChunkType.Schedule,            "table_like" => ChunkType.TableLike,            "formula" => ChunkType.Formula,            "code_block" => ChunkType.CodeBlock,            "image" => ChunkType.Image,            "org_chart" => ChunkType.OrgChart,            "diagram" => ChunkType.Diagram,            "unknown" => ChunkType.Unknown,            _ => throw new JsonException($"Unknown ChunkType value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, ChunkType value, JsonSerializerOptions options)
    {
        ...
        {            ChunkType.Heading => "heading",            ChunkType.PartyList => "party_list",            ChunkType.Definitions => "definitions",            ChunkType.OperativeClause => "operative_clause",            ChunkType.SignatureBlock => "signature_block",            ChunkType.Schedule => "schedule",            ChunkType.TableLike => "table_like",            ChunkType.Formula => "formula",            ChunkType.CodeBlock => "code_block",            ChunkType.Image => "image",            ChunkType.OrgChart => "org_chart",            ChunkType.Diagram => "diagram",            ChunkType.Unknown => "unknown",            _ => throw new JsonException($"Unknown ChunkType value: {value}")
        };
