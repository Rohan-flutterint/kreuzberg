...
internal sealed class HtmlThemeJsonConverter : JsonConverter<HtmlTheme>
{
    public override HtmlTheme Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "default" => HtmlTheme.Default,            "github" => HtmlTheme.GitHub,            "dark" => HtmlTheme.Dark,            "light" => HtmlTheme.Light,            "unstyled" => HtmlTheme.Unstyled,            _ => throw new JsonException($"Unknown HtmlTheme value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, HtmlTheme value, JsonSerializerOptions options)
    {
        ...
        {            HtmlTheme.Default => "default",            HtmlTheme.GitHub => "github",            HtmlTheme.Dark => "dark",            HtmlTheme.Light => "light",            HtmlTheme.Unstyled => "unstyled",            _ => throw new JsonException($"Unknown HtmlTheme value: {value}")
        };
