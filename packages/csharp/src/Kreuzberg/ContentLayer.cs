...
internal sealed class ContentLayerJsonConverter : JsonConverter<ContentLayer>
{
    public override ContentLayer Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        return value switch
        {            "body" => ContentLayer.Body,            "header" => ContentLayer.Header,            "footer" => ContentLayer.Footer,            "footnote" => ContentLayer.Footnote,            _ => throw new JsonException($"Unknown ContentLayer value: {value}")
        };
    }
    ...
    public override void Write(Utf8JsonWriter writer, ContentLayer value, JsonSerializerOptions options)
    {
        ...
        {            ContentLayer.Body => "body",            ContentLayer.Header => "header",            ContentLayer.Footer => "footer",            ContentLayer.Footnote => "footnote",            _ => throw new JsonException($"Unknown ContentLayer value: {value}")
        };
