...
# alef:hash:a001a49d3244572bf2b387ae5e9dbefa0d46fc3cac07bf4d985fa0caf5aae899
...
async def test_batch_file_async_basic() -> None:
    ...
    result = await batch_extract_files(paths, None)
...
def test_batch_file_not_found() -> None:
    ...
    result = batch_extract_files_sync(paths, None)
